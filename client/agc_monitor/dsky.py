from PySide2.QtWidgets import QWidget, QPushButton, QStyleOption, QStyle
...
class DSKY(QWidget):
    ...
    def _create_button(self, x, y, keycode):
        ...
        if keycode is None:
            b.pressed.connect(lambda: self._usbif.send(um.DSKYProceed(1)))
