...
class MonitorPanel(QFrame):
    ...
    def _setup_ui(self):
        column_layout = QHBoxLayout(self)
        ...
        column_layout.addWidget(col1)

        self._write_w = WriteW(col1, self._usbif)
        ...
        col2_layout.addWidget(regs)
        col2_layout.setAlignment(regs, Qt.AlignTop)
