...
module a02_timer(
    ...
    // Clock divider 1
    nor_2 #(1'b0) NOR37101(NOR37101_out,    NOR37105_out,   NOR37102_out,                   reset, prop_clk);
    nor_3 #(1'b0) NOR37102(NOR37102_out,    NOR37101_out,   CLOCK,          NOR37103_out,   reset, prop_clk);
    nor_3 #(1'b1) NOR37103(NOR37103_out,    NOR37102_out,   CLOCK,          PHS2,           reset, prop_clk);
    nor_2 #(1'b0) NOR37104(PHS2,            NOR37103_out,   NOR37106_out,                   reset, prop_clk);
    nor_2 #(1'b1) NOR37105(NOR37105_out,    NOR37102_out,   NOR37106_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR37106(NOR37106_out,    NOR37105_out,   NOR37103_out,                   reset, prop_clk);
    ...
    nor_3 #(1'b0) NOR37112(NOR37112_out,    NOR37111_out,   NOR37107_out,   NOR37113_out,   reset, prop_clk);
    nor_3 #(1'b1) NOR37113(NOR37113_out,    NOR37112_out,   NOR37107_out,   NOR37114_out,   reset, prop_clk);
    nor_2 #(1'b0) NOR37114(NOR37114_out,    NOR37113_out,   NOR37118_out,                   reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR37118(NOR37118_out,    NOR37117_out,   NOR37113_out,                   reset, prop_clk);
    ...
    // MONWT
    nor_2 #(1'b0) NOR37136(NOR37136_out,    WT_,            WT_,                            reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MONWT = NOR37136_out;
    
    // CLK
    nor_1 #(1'b0) NOR37137(CLK,             WT_,                                            reset, prop_clk);
    
    // Q2A
    nor_3 #(1'b0) NOR37138(NOR37138_out,    WT_,            WT_,            WT_,            reset, prop_clk);
    ...
    // OVFSTB
    nor_2 #(1'b0) NOR37148(NOR37148_out,    CT_,            NOR37149_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR37149(NOR37149_out,    NOR37154_out,   NOR37148_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR37150(NOR37150_out,    NOR37152_out,   NOR37149_out,                   reset, prop_clk);
    nor_1 #(1'b1) NOR37151(OVFSTB_,         NOR37149_out,                                   reset, prop_clk);
    nor_2 #(1'b1) NOR37152(NOR37152_out,    NOR37150_out,   NOR37148_out,                   reset, prop_clk);
    nor_1 #(1'b0) NOR37153(NOR37153_out,    NOR37152_out,                                   reset, prop_clk);
    nor_1 #(1'b1) NOR37154(NOR37154_out,    NOR37153_out,                                   reset, prop_clk);
    ...
    nor_3 #(1'b0) NOR37201(NOR37201_out,    RINGB_,         P05_,           P04_,           reset, prop_clk);
    nor_3 #(1'b0) NOR37202(NOR37202_out,    RINGA_,         P04,            P05,            reset, prop_clk);
    nor_2 #(1'b0) NOR37203(P01,             NOR37201_out,   P01_,                           reset, prop_clk);
    nor_2 #(1'b1) NOR37204(P01_,            P01,            NOR37202_out,                   reset, prop_clk);

    nor_2 #(1'b0) NOR37205(NOR37205_out,    RINGA_,         P01,                            reset, prop_clk);
    nor_2 #(1'b0) NOR37206(NOR37206_out,    RINGB_,         P01_,                           reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR37214(NOR37214_out,    RINGB_,         P03_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR37215(P04,             NOR37213_out,   P04_,                           reset, prop_clk);
    nor_2 #(1'b1) NOR37216(P04_,            P04,            NOR37214_out,                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR37217(NOR37217_out,    RINGB_,         P04,                            reset, prop_clk);
    nor_2 #(1'b0) NOR37218(NOR37218_out,    RINGA_,         P04_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR37219(P05,             NOR37217_out,   P05_,                           reset, prop_clk);
    nor_2 #(1'b1) NOR37220(P05_,            P05,            NOR37218_out,                   reset, prop_clk);
    
    // Clock divider 3
    nor_2 #(1'b0) NOR37221(F01D,            FS01_,          F01B,                           reset, prop_clk);
    nor_3 #(1'b0) NOR37222(F01B,            F01D,           P01_,           F01A,           reset, prop_clk);
    nor_3 #(1'b1) NOR37223(F01A,            F01B,           P01_,           F01C,           reset, prop_clk);
    nor_2 #(1'b0) NOR37224(F01C,            F01A,           FS01,                           reset, prop_clk);
    nor_2 #(1'b1) NOR37225(FS01_,           F01B,           FS01,                           reset, prop_clk);
    nor_2 #(1'b0) NOR37226(FS01,            FS01_,          F01A,                           reset, prop_clk);
    
    // Restart logic
    nor_3 #(1'b1) NOR37227(NOR37227_out,    SBY,            ALGA,           MSTRTP,         reset, prop_clk);
    nor_3 #(1'b1) NOR37228(NOR37228_out,    STRT1,          STRT2,          NOR37229_out,   reset, prop_clk);
    // Single output, no cross-module fan-in, not connected to the outside
    assign GOSET_ = NOR37227_out & NOR37228_out;
    
    nor_2 #(1'b0) NOR37229(NOR37229_out,    GOSET_,         GOJ1,                           reset, prop_clk);
    nor_1 #(1'b0) NOR37230(NOR37230_out,    GOSET_,                                         reset, prop_clk);
    nor_3 #(1'b0) NOR37231(NOR37231_out,    T12DC_,         GOSET_,         EVNSET_,        reset, prop_clk);
    nor_2 #(1'b0) NOR37232(NOR37232_out,    EVNSET_,        NOR37230_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR37233(NOR37233_out,    NOR37231_out,   STOPA,                          reset, prop_clk);
    nor_2 #(1'b1) NOR37234(STOPA,           NOR37233_out,   NOR37232_out,                   reset, prop_clk);
    nor_1 #(1'b0) NOR37235(NOR37235_out,    MSTP,                                           reset, prop_clk);
    nor_3 #(1'b0) NOR37236(NOR37236_out,    T12DC_,         NOR37235_out,   EVNSET_,        reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR37256(SB1,             P05_,           P03_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR37257(SB2,             P05_,           P02,                            reset, prop_clk);
    nor_2 #(1'b0) NOR37258(SB4,             P02_,           P04,                            reset, prop_clk);
    nor_3 #(1'b0) NOR37259(EDSET,           P02,            P03_,           P04,            reset, prop_clk);
    
    // SB0_, SB1_, SB2_ moved here from A24 sheet 1
    nor_1 #(1'b0) NOR49224(SB0_,            SB0,                                            reset, prop_clk);
    nor_1 #(1'b0) NOR49226(SB1_,            SB1,                                            reset, prop_clk);
    nor_1 #(1'b0) NOR49228(SB2_,            SB2,                                            reset, prop_clk);
     ...
     **************************/
     ...
     nor_2 #(1'b0) NOR37303(NOR37303_out,   T12DC_,         NOR37306_out,                   reset, prop_clk);
     nor_2 #(1'b0) NOR37304(NOR37304_out,   T12DC_,         ODDSET_,                        reset, prop_clk);
     
     nor_2 #(1'b1) NOR37305(T01DC_,         NOR37304_out,   NOR37306_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37306(NOR37306_out,   T01DC_,         NOR37310_out,   GOJAM,          reset, prop_clk);
     nor_2 #(1'b0) NOR37307(T01,            T01DC_,         ODDSET_,                        reset, prop_clk);
     nor_2 #(1'b0) NOR37308(NOR37308_out,   T01DC_,         EVNSET_,                        reset, prop_clk);
     
     nor_2 #(1'b1) NOR37309(T02DC_,         NOR37308_out,   NOR37310_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37310(NOR37310_out,   T02DC_,         NOR37314_out,   GOJAM,          reset, prop_clk);
     nor_2 #(1'b0) NOR37311(T02,            T02DC_,         EVNSET_,                        reset, prop_clk);
     nor_2 #(1'b0) NOR37312(NOR37312_out,   T02DC_,         ODDSET_,                        reset, prop_clk);
     
     nor_2 #(1'b1) NOR37313(T03DC_,         NOR37312_out,   NOR37314_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37314(NOR37314_out,   T03DC_,         NOR37318_out,   GOJAM,          reset, prop_clk);
     nor_2 #(1'b0) NOR37315(T03,            T03DC_,         ODDSET_,                        reset, prop_clk);
     nor_2 #(1'b0) NOR37316(NOR37316_out,   T03DC_,         EVNSET_,                        reset, prop_clk);
     
     nor_2 #(1'b1) NOR37317(T04DC_,         NOR37316_out,   NOR37318_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37318(NOR37318_out,   T04DC_,         NOR37322_out,   GOJAM,          reset, prop_clk);
     nor_2 #(1'b0) NOR37319(T04,            T04DC_,         EVNSET_,                        reset, prop_clk);
     nor_2 #(1'b0) NOR37320(NOR37320_out,   T04DC_,         ODDSET_,                        reset, prop_clk);
     ...
     nor_3 #(1'b0) NOR37327(NOR37327_out,   GOJAM,          NOR37331_out,   T06DC_,         reset, prop_clk);
     nor_2 #(1'b0) NOR37328(T06,            EVNSET_,        T06DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37329(NOR37329_out,   ODDSET_,        T06DC_,                         reset, prop_clk);
     
     nor_2 #(1'b1) NOR37330(T07DC_,         NOR37331_out,   NOR37329_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37331(NOR37331_out,   GOJAM,          NOR37335_out,   T07DC_,         reset, prop_clk);
     nor_2 #(1'b0) NOR37332(T07,            ODDSET_,        T07DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37333(NOR37333_out,   EVNSET_,        T07DC_,                         reset, prop_clk);
     
     nor_2 #(1'b1) NOR37334(T08DC_,         NOR37335_out,   NOR37333_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37335(NOR37335_out,   GOJAM,          NOR37339_out,   T08DC_,         reset, prop_clk);
     nor_2 #(1'b0) NOR37336(T08,            EVNSET_,        T08DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37337(NOR37337_out,   ODDSET_,        T08DC_,                         reset, prop_clk);
     
     nor_2 #(1'b1) NOR37338(T09DC_,         NOR37339_out,   NOR37337_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37339(NOR37339_out,   GOJAM,          NOR37343_out,   T09DC_,         reset, prop_clk);
     nor_2 #(1'b0) NOR37340(T09,            ODDSET_,        T09DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37341(NOR37341_out,   EVNSET_,        T09DC_,                         reset, prop_clk);
     
     nor_2 #(1'b1) NOR37342(T10DC_,         NOR37343_out,   NOR37341_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37343(NOR37343_out,   GOJAM,          NOR37348_out,   T10DC_,         reset, prop_clk);
     nor_2 #(1'b0) NOR37344(T10,            EVNSET_,        T10DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37345(NOR37345_out,   ODDSET_,        T10DC_,                         reset, prop_clk);
     nor_2 #(1'b0) NOR37346(NOR37346_out,   NOR37343_out,   EVNSET_,                        reset, prop_clk);
     
     nor_2 #(1'b1) NOR37347(NOR37347_out,   NOR37348_out,   NOR37345_out,                   reset, prop_clk);
     nor_3 #(1'b0) NOR37348(NOR37348_out,   GOJAM,          NOR37346_out,   NOR37347_out,   reset, prop_clk);
     ...
     nor_2 #(1'b0) NOR37358(NOR37358_out,   NOR37310_out,   NOR37306_out,                   reset, prop_clk);
