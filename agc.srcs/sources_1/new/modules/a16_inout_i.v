...
module a16_inout_i(
    ...
    **************************/
    ...
    nor_2 #(1'b1) NOR43256(NOR43256_out,    NOR43255_out,   NOR43257_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43251(NOR43251_out,    NOR43250_out,   NOR43252_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43246(NOR43246_out,    NOR43245_out,   NOR43247_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43241(NOR43241_out,    NOR43240_out,   NOR43242_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43236(NOR43236_out,    NOR43235_out,   NOR43237_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43231(NOR43231_out,    NOR43230_out,   NOR43232_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43220(NOR43220_out,    NOR43219_out,   NOR43221_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b1) NOR43202(NOR43202_out,    NOR43201_out,   NOR43203_out,                                   reset, prop_clk);
    ...
    **************************/
    ...
    nor_2 #(1'b0) NOR43305(NOR43305_out,    CHWL01_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43303(NOR43303_out,    NOR43305_out,   NOR43304_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43304(NOR43304_out,    NOR43303_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43301(NOR43301_out,    RCH12_,         NOR43303_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43302(ZOPCDU,          NOR43303_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43306(NOR43306_out,    CHWL02_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43307(NOR43307_out,    NOR43306_out,   NOR43308_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43308(NOR43308_out,    NOR43307_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43309(NOR43309_out,    RCH12_,         NOR43307_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43310(ENEROP,          NOR43307_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43315(NOR43315_out,    CHWL03_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43313(NOR43313_out,    NOR43315_out,   NOR43314_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43314(NOR43314_out,    NOR43313_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43311(NOR43311_out,    RCH12_,         NOR43313_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43312(STARON,          NOR43313_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43316(NOR43316_out,    CHWL04_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43317(NOR43317_out,    NOR43316_out,   NOR43318_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43318(NOR43318_out,    NOR43317_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43319(NOR43319_out,    RCH12_,         NOR43317_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43320(COARSE,          NOR43317_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43325(NOR43325_out,    CHWL05_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43323(NOR43323_out,    NOR43325_out,   NOR43324_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43324(NOR43324_out,    NOR43323_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43321(NOR43321_out,    RCH12_,         NOR43323_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43322(ZIMCDU,          NOR43323_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43326(NOR43326_out,    CHWL06_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43327(NOR43327_out,    NOR43326_out,   NOR43328_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43328(NOR43328_out,    NOR43327_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43329(NOR43329_out,    RCH12_,         NOR43327_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43330(ENERIM,          NOR43327_out,                                                   reset, prop_clk);
    ...
    nor_1 #(1'b0) NOR43346(WCH12_,          NOR43349_out,                                                   reset, prop_clk);
    // NOR43347 and NOR43348 removed (fan-out expansion)
    
    nor_3 #(1'b0) NOR43350(NOR43350_out,    CCHG_,          XT1_,           XB2_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR43351(NOR43351_out,    NOR43350_out,   GOJAM,                                          reset, prop_clk);
    nor_1 #(1'b0) NOR43352(CCH12,           NOR43351_out,                                                   reset, prop_clk);
    // NOR43353 and NOR43354 removed (fan-out expansion)
    
    nor_2 #(1'b0) NOR43355(NOR43355_out,    XT1_,           XB2_,                                           reset, prop_clk);
    nor_1 #(1'b0) NOR43356(RCH12_,          NOR43355_out,                                                   reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR43405(NOR43405_out,    CHWL01_,        WCH11_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43404(NOR43404_out,    NOR43405_out,   NOR43403_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43403(NOR43403_out,    NOR43404_out,   CCH11,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43402(NOR43402_out,    RCH11_,         NOR43404_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43401(ISSWAR,          NOR43404_out,                                                   reset, prop_clk);
    nor_3 #(1'b0) NOR43407(A16_2_CHOR01_,   NOR43301_out,   NOR43402_out,   CH1501,                         reset, prop_clk);
    
    nor_2 #(1'b0) NOR43406(NOR43406_out,    CHWL02_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43409(NOR43409_out,    NOR43406_out,   NOR43410_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43410(NOR43410_out,    NOR43409_out,   CCH11,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43411(NOR43411_out,    RCH11_,         NOR43409_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43412(COMACT,          NOR43409_out,                                                   reset, prop_clk);
    nor_3 #(1'b0) NOR43408(A16_2_CHOR02_,   NOR43309_out,   NOR43409_out,   CH1502,                         reset, prop_clk);
    
    nor_2 #(1'b0) NOR43417(NOR43417_out,    CHWL03_,        WCH11_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43416(NOR43416_out,    NOR43417_out,   NOR43415_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43415(NOR43415_out,    NOR43416_out,   CCH11,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43414(NOR43414_out,    RCH11_,         NOR43416_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43413(UPLACT,          NOR43416_out,                                                   reset, prop_clk);
    nor_3 #(1'b0) NOR43419(A16_2_CHOR03_,   NOR43311_out,   NOR43414_out,   CH1503,                         reset, prop_clk);
    
    nor_2 #(1'b0) NOR43418(NOR43418_out,    CHWL04_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43421(NOR43421_out,    NOR43418_out,   NOR43422_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43422(NOR43422_out,    NOR43421_out,   CCH11,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43423(NOR43423_out,    RCH11_,         NOR43421_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43424(TMPOUT,          NOR43421_out,                                                   reset, prop_clk);
    nor_3 #(1'b0) NOR43420(A16_2_CHOR04_,   NOR43319_out,   NOR43421_out,   CH1504,                         reset, prop_clk);
    
    nor_2 #(1'b0) NOR43431(NOR43431_out,    CHWL05_,        WCH11_,                                         reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR43446(NOR43446_out,    CHWL12_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43447(NOR43447_out,    NOR43446_out,   NOR43448_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43448(NOR43448_out,    NOR43447_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43449(CH1212,          RCH12_,         NOR43447_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43450(MROLGT,          NOR43447_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43455(NOR43455_out,    CHWL13_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43454(NOR43454_out,    NOR43455_out,   NOR43453_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43453(NOR43453_out,    NOR43454_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43452(CH1213,          RCH12_,         NOR43454_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43451(S4BSEQ,          NOR43454_out,                                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR43456(NOR43456_out,    CHWL14_,        WCH12_,                                         reset, prop_clk);
    nor_2 #(1'b1) NOR43457(NOR43457_out,    NOR43456_out,   NOR43458_out,                                   reset, prop_clk);
    nor_2 #(1'b0) NOR43458(NOR43458_out,    NOR43457_out,   CCH12,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR43459(CH1214,          RCH12_,         NOR43457_out,                                   reset, prop_clk);
    nor_1 #(1'b0) NOR43460(S4BOFF,          NOR43457_out,                                                   reset, prop_clk);
endmodule
