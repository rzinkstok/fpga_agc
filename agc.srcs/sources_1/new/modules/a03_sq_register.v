...
module a03_sq_register(
    ...
    **************************/
    ...
    nor_3 #(1'b0) NOR30003(NOR30003_out,    T12_,           NOR30001_out,   RPTFRC,         reset, prop_clk);
    nor_1 #(1'b0) NOR30004(NISQL_,          NOR30002_out,                                   reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR30014(NOR30014_out,    WL14_,          WSQG_,                          reset, prop_clk);
    nor_2 #(1'b0) NOR30015(NOR30015_out,    WL13_,          WSQG_,                          reset, prop_clk);
    
    // Sequence register flip-flops 
    nor_2 #(1'b1) NOR30016(NOR30016_out,    NOR30013_out,   SQR16,                          reset, prop_clk);
    nor_3 #(1'b0) NOR30017(SQR16,           NOR30016_out,   RPTFRC,         CSQG,           reset, prop_clk);
    
    nor_2 #(1'b1) NOR30018(NOR30018_out,    NOR30014_out,   SQR14,                          reset, prop_clk);
    nor_3 #(1'b0) NOR30019(SQR14,           NOR30018_out,   RPTFRC,         CSQG,           reset, prop_clk);
    
    nor_2 #(1'b1) NOR30020(NOR30020_out,    NOR30015_out,   SQR13,                          reset, prop_clk);
    nor_3 #(1'b0) NOR30021(SQR13,           NOR30020_out,   RPTFRC,         CSQG,           reset, prop_clk);
    
    // Sequence register monitor signals
    nor_1 #(1'b0) NOR30022(NOR30022_out,    NOR30016_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MSQ16 = NOR30022_out;
    
    // Moved here from below
    nor_1 #(1'b0) NOR30025(NOR30025_out,    NOR30018_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MSQ14 = NOR30025_out;
    
    // Moved here from below
    nor_1 #(1'b0) NOR30028(NOR30028_out,    NOR30020_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    ...
    nor_3 #(1'b0) NOR30038(NOR30038_out,    NOR30020_out,   NOR30034_out,   NOR30032_out,   reset, prop_clk);
    nor_3 #(1'b0) NOR30039(NOR30039_out,    NOR30020_out,   NOR30034_out,   NOR30031_out,   reset, prop_clk);
    nor_3 #(1'b0) NOR30040(NOR30040_out,    NOR30036_out,   NOR30018_out,   NOR30032_out,   reset, prop_clk);
    nor_3 #(1'b0) NOR30041(NOR30041_out,    NOR30020_out,   NOR30018_out,   NOR30032_out,   reset, prop_clk);
    nor_3 #(1'b0) NOR30042(NOR30042_out,    NOR30036_out,   NOR30034_out,   NOR30031_out,   reset, prop_clk);
    nor_3 #(1'b0) NOR30043(NOR30043_out,    NOR30036_out,   NOR30018_out,   NOR30031_out,   reset, prop_clk);
    ...
    // FUTEXT flip-flop
    nor_3 #(1'b1) NOR30109(NOR30109_out,    EXTPLS,         EXT,            FUTEXT,         reset, prop_clk);
    nor_3 #(1'b0) NOR30110(FUTEXT,          NOR30109_out,   INKBT1,         STRTFC,         reset, prop_clk);
    
    nor_2 #(1'b0) NOR30113(NOR30113_out,    STRTFC,         NOR30108_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR30114(NOR30114_out,    NOR30113_out,   NOR30109_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR30115(NOR30115_out,    NOR30113_out,   FUTEXT,                         reset, prop_clk);
    
    // Extend bit flip-flop
    nor_3 #(1'b1) NOR30119(NOR30119_out,    RPTFRC,         NOR30114_out,   NOR30120_out,   reset, prop_clk);
    nor_2 #(1'b0) NOR30120(NOR30120_out,    NOR30119_out,   NOR30115_out,                   reset, prop_clk);
    
    // Extend bit signals
    nor_1 #(1'b0) NOR30123(NOR30123_out,    NOR30119_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    ...
    nor_3 #(1'b0) NOR30104(INHINT,          NOR30103_out,   RELPLS,         GOJAM,          reset, prop_clk);
    nor_1 #(1'b0) NOR30111(NOR30111_out,    NOR30103_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MINHL = NOR30111_out;
    
    // Interrupt in progress flip-flop
    nor_2 #(1'b1) NOR30105(IIP_,            KRPT,           IIP,                            reset, prop_clk);
    nor_3 #(1'b0) NOR30106(IIP,             IIP_,           GOJAM,          n5XP4,          reset, prop_clk);
    nor_1 #(1'b0) NOR30112(NOR30112_out,    IIP_,                                           reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MIIP = NOR30112_out;
    
    // OVNHRP
    // Moved here from module A24 sheet 1
    nor_1 #(1'b0) NOR49101(NOR49101_out,    A16_,                                           reset, prop_clk);
    nor_1 #(1'b0) NOR49102(NOR49102_out,    A15_,                                           reset, prop_clk);
    nor_2 #(1'b0) NOR49103(NOR49103_out,    NOR49101_out,   A15_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR49104(NOR49104_out,    A16_,           NOR49102_out,                   reset, prop_clk);
    nor_2 #(1'b1) NOR49105(NOR49105_out,    NOR49103_out,   NOR49104_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR49106(NOR49106_out,    NOR49105_out,   NISQ_,                          reset, prop_clk);
    nor_3 #(1'b0) NOR49107(NOR49107_out,    NOR49103_out,   NOR49104_out,   NISQ_,          reset, prop_clk);
    nor_2 #(1'b1) NOR49108(NOR49108_out,    NOR49106_out,   OVNHRP,                         reset, prop_clk);
    nor_3 #(1'b0) NOR49109(OVNHRP,          NOR49108_out,   NOR49107_out,   MP3,            reset, prop_clk);
    
    // RPTSET
    // Cross-module fan-in, connected to A6
    nor_3 #(1'b0) NOR30116(A03_1_RPTSET,    FUTEXT,         NISQL_,         T12_,           reset, prop_clk);
    nor_3 #(1'b0) NOR30117(A03_2_RPTSET,    PHS2_,          RUPTOR_,        MNHRPT,         reset, prop_clk);
    nor_3 #(1'b0) NOR30118(A03_3_RPTSET,    OVNHRP,         INHINT,         IIP,            reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR30130(NOR30130_out,    WL11_,          WSQG_,                          reset, prop_clk);
    nor_2 #(1'b0) NOR30131(NOR30131_out,    WL10_,          WSQG_,                          reset, prop_clk);
    
    // Quarter Code register flip-flops
    nor_3 #(1'b1) NOR30132(NOR30132_out,    RPTFRC,         NOR30129_out,   SQR12,          reset, prop_clk);
    nor_2 #(1'b0) NOR30133(SQR12,           NOR30132_out,   CSQG,                           reset, prop_clk);
    nor_1 #(1'b0) NOR30157(SQR12_,          SQR12,                                          reset, prop_clk);
    
    nor_3 #(1'b1) NOR30134(NOR30134_out,    RPTFRC,         NOR30130_out,   SQR11,          reset, prop_clk);
    nor_2 #(1'b0) NOR30135(SQR11,           NOR30134_out,   CSQG,                           reset, prop_clk);
    
    nor_3 #(1'b1) NOR30136(NOR30136_out,    RPTFRC,         NOR30131_out,   SQR10,          reset, prop_clk);
    nor_2 #(1'b0) NOR30137(NOR30137_out,    NOR30136_out,   CSQG,                           reset, prop_clk);
    
    // Quarter Code register monitor signals
    nor_1 #(1'b0) NOR30138(NOR30138_out,    NOR30132_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MSQ12 = NOR30138_out;
    
    nor_1 #(1'b0) NOR30139(NOR30139_out,    NOR30134_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MSQ11 = NOR30139_out;
    
    nor_1 #(1'b0) NOR30140(NOR30140_out,    NOR30136_out,                                   reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MSQ10 = NOR30140_out;
    
    // Quarter Code register decoding
    nor_2 #(1'b0) NOR30141(QC0,             SQR11,          SQR12,                          reset, prop_clk);
    nor_2 #(1'b0) NOR30142(NOR30142_out,    NOR30134_out,   SQR12,                          reset, prop_clk);
    nor_2 #(1'b0) NOR30143(NOR30143_out,    SQR11,          NOR30132_out,                   reset, prop_clk);
    ...
    **************************/
    ...
    nor_1 #(1'b0) NOR49419(IC11_,           IC11,                                           reset, prop_clk);
    
    nor_2 #(1'b0) NOR30314(NOR30314_out,    SQEXT_,         ST1_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR30315(NOR30315_out,    NOR30314_out,   NEXST0,                         reset, prop_clk);
    nor_1 #(1'b0) NOR30316(EXST1_,          NOR30314_out,                                   reset, prop_clk);
    
    nor_2 #(1'b0) NOR30317(IC6,             NOR30315_out,   SQ3_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR30318(IC7,             NOR30315_out,   SQ4_,                           reset, prop_clk);
    
    nor_2 #(1'b0) NOR30319(TC0,             SQ0_,           NEXST0_,                        reset, prop_clk);
    nor_3 #(1'b0) NOR30320(TCF0,            SQ1_,           NEXST0_,        QC0,            reset, prop_clk);
    nor_2 #(1'b0) NOR30321(NEXST0,          SQEXT,          ST0_,                           reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR30329(IC4_,            DCS0,           DCA0,                           reset, prop_clk);
    nor_1 #(1'b0) NOR30330(IC4,             IC4_,                                           reset, prop_clk);
    
    nor_3 #(1'b0) NOR30331(NOR30331_out,    IC7,            IC6,            IC11,           reset, prop_clk);
    nor_3 #(1'b0) NOR30332(NOR30332_out,    IC1,            DCS0,           DCA0,           reset, prop_clk);
    ...
    nor_1 #(1'b0) NOR30343(QXCH0_,          QXCH0,                                          reset, prop_clk);
    
    nor_2 #(1'b0) NOR30346(IC8_,            DXCH0,          LXCH0,                          reset, prop_clk);
    nor_2 #(1'b0) NOR30347(NOR30347_out,    ST0_,           SQEXT_,                         reset, prop_clk);
    ...
    nor_3 #(1'b0) NOR30405(BMF0,            EXST0_,         QC0,            SQ6_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30406(BMF0_,           BMF0,                                           reset, prop_clk);
    nor_2 #(1'b0) NOR30407(NOR30407_out,    BZF0_,          BR2_,                           reset, prop_clk);
    nor_2 #(1'b0) NOR30408(NOR30408_out,    BMF0_,          BR1B2B,                         reset, prop_clk);
    nor_2 #(1'b0) NOR30409(IC16_,           NOR30407_out,   NOR30408_out,                   reset, prop_clk);
    nor_2 #(1'b0) NOR30410(IC15_,           BMF0,           BZF0,                           reset, prop_clk);
    nor_1 #(1'b0) NOR30411(IC16,            IC16_,                                          reset, prop_clk);
    ...
    nor_2 #(1'b0) NOR30422(IC12_,           CCS0,           MSU0,                           reset, prop_clk);
    nor_1 #(1'b0) NOR30423(IC12,            IC12_,                                          reset, prop_clk);
    
    nor_3 #(1'b0) NOR30424(ADS0,            SQ2_,           QC3_,           NEXST0_,        reset, prop_clk);
    nor_3 #(1'b0) NOR30425(INCR0,           QC2_,           SQ2_,           NEXST0_,        reset, prop_clk);
    nor_3 #(1'b0) NOR30426(MSU0,            SQ2_,           EXST0_,         QC0_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30427(MSU0_,           MSU0,                                           reset, prop_clk);
    nor_3 #(1'b0) NOR30428(AUG0,            SQ2_,           EXST0_,         QC2_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30429(AUG0_,           AUG0,                                           reset, prop_clk);
    nor_3 #(1'b0) NOR30430(DIM0,            SQ2_,           EXST0_,         QC3_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30431(DIM0_,           DIM0,                                           reset, prop_clk);
    ...
    nor_1 #(1'b0) NOR30438(NOR30438_out,    TCSAJ3,                                         reset, prop_clk);
    // Single monitor fan-in output, no cross-module fan-in
    assign MTCSA_ = NOR30438_out;
    
    nor_3 #(1'b0) NOR30443(RSM3,            ST3_,           SQ5QC0_,        SQEXT,          reset, prop_clk);
    nor_1 #(1'b0) NOR30444(RSM3_,           RSM3,                                           reset, prop_clk);
    nor_3 #(1'b0) NOR30445(SU0,             SQ6_,           EXST0_,         QC0_,           reset, prop_clk);
    nor_2 #(1'b0) NOR30446(MASK0,           SQ7_,           NEXST0_,                        reset, prop_clk);
    nor_1 #(1'b0) NOR30447(MASK0_,          MASK0,                                          reset, prop_clk);
    nor_2 #(1'b0) NOR30448(AD0,             NEXST0_,        SQ6_,                           reset, prop_clk);
    nor_3 #(1'b0) NOR30449(NDX0,            NEXST0_,        SQ5_,           QC0_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30450(NDX0_,           NDX0,                                           reset, prop_clk);
    nor_3 #(1'b0) NOR30451(NDXX1,           SQEXT_,         SQ5_,           ST1_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30452(NDXX1_,          NDXX1,                                          reset, prop_clk);
    nor_3 #(1'b0) NOR30453(GOJ1,            SQEXT,          ST1_,           SQ0_,           reset, prop_clk);
    nor_1 #(1'b0) NOR30454(GOJ1_,           GOJ1,                                           reset, prop_clk);
